  ...
  return (
    <Router>
      <div>
        ...
        <Routes>
          {/* Root route - always redirects to login if not authenticated */}
          <Route 
            path="/" 
            element={
              isAuthenticated ? 
          ...
          <Route path="/receiver" element={<ProtectedRoute Component={Receiver} allowedRoles={["admin","security_officer","super admin","executive_officer","duty_officer","patrol_leader"]} />} />
          ...
          <Route
            ...
            element={
              isAuthenticated ? (
                <Navigate to={role === "admin" || role === "super admin" ? "/admin" : "/home"} replace />
              ) : (
